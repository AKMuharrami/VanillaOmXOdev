        ...
        <div className={styles.card3} style={{position:'relative', height:'8vh', alignItems:'center'}}>
          ...
          >
            ...
            VanillaOm
              ...
              <h2 style={{color:'white', textAlign:'center', marginTop:'7%', marginBottom:'6%', marginRight:'0%'}}>Bourbon (Planifolia) <br></br>Vanilla beans</h2>
                    ...
                    <div style={{marginLeft:'5vw'}}>
                        ...
                        <form onSubmit={handleSubmit}>
                            ...
                            <br></br>
                            <div style={{display:'flex',justifyContent:'center'}}>
                            <label For='POC' style={{color:'white', fontSize:'100%'}}>Landmark (near you)</label>
