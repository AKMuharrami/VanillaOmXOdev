  ...
  return (
    ...
    {isDesktopOrLaptop &&<div>
                    ...
                    <div style={{marginLeft:'5vw'}}>
                        <h1 style={{color:'white', textAlign:'center', marginTop:'-7%', marginBottom:'6%', marginLeft:'35%', textShadow: '1px 1px 5px rgb(00 11 69/ 80%)', WebkitTextStroke: '1px 0b0e13'}}>أعواد فانيلا (بوربن) - درجة أ</h1>
